                ...
                <div class="row">
                    ...
                    <section class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('product.update',['id'=>$product->id])}}" method="post" id="myForm">
                                    @csrf
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="name" id="name" class="form-control" style="@if($errors->has('name')) border-color:red; @endif" value="{{$product->name}}">
